...
export const translations = {
  ar: {
    socialSection: {
      "badge": "أنشطة وفعاليات ميدانية",
      "title": "منشورات وفعاليات المنصات الرسمية",
      "subtitle": "تابع أحدث الورش التدريبية، البعثات الميدانية، وبرامج التطوير المؤسسي المنشورة عبر قنواتنا على فيسبوك وإنستغرام.",
      "viewFb": "شاهد على فيسبوك ↗",
      "viewInsta": "شاهد على إنستغرام ↗",
      "filterAll": "الكل",
      "filterTraining": "تدريب ومعايير",
      "filterProtection": "حماية وصون كرامة",
      ...
      "posts": [
        ...
        },
        {
          "id": "post-gov",
          "category": "governance",
          "title": "بناء النظم الإدارية وأدلة السياسات والإجراءات القياسية (SOPs)",
          "date": "أغسطس 2026",
          "readTime": "3 دقائق قراءة",
          "tag": "تطوير مؤسسي",
          "platform": "Instagram",
        ...
        },
        {
          "id": "post-moodle",
          "category": "academy",
          "title": "إطلاق بوابة كلاس روم ومنظومة المودل للأكاديمية والتدريب",
          "date": "سبتمبر 2026",
          "readTime": "3 دقائق قراءة",
          "tag": "الأكاديمية الرقمية",
          "platform": "Facebook",
        ...
        },
        {
          ...
          "title": "توسيع شبكة الشراكات الاستراتيجية والتحالفات الإقليمية 2026",
          "date": "أغسطس 2026",
          "readTime": "4 دقائق قراءة",
    ...
    moodleLMS: {
      "gateBadge": "بوابة مغلقة • نظام المودل المؤسسي",
      "gateTitle": "منظومة المودل للأكاديمية والتدريب",
      "gateDesc": "مساحة تعليمية متقدمة مخصصة للطلاب، المدربين، ومسؤولي الإدارة في شركة شات للتنمية والتطوير.",
      "gatePrompt": "يرجى تسجيل الدخول للوصول إلى نظام المودل",
      "gateRolesIntro": "تتيح لك المنصة الدخول المخصص حسب صلاحيات حسابك المسجل:",
      "roleStudentTitle": "حساب الطالب / المتدرب",
      "roleStudentDesc": "عرض المقررات، نسبة الإنجاز، تحميل ملفات Google Drive مباشرة، وشات الأستاذ.",
      "roleInstructorTitle": "حساب المدرب / الأستاذ",
      "roleInstructorDesc": "رفع الحقائب والملفات مباشرة للمنصة ودرايف، متابعة الحضور، والرد على استفسارات الطلاب.",
      "roleAdminTitle": "حساب الإدارة والمشرفين",
      "roleAdminDesc": "تفعيل وإيقاف الكورسات، لوحة الحفظ العائمة، وإدارة شات وبريد الموظفين الداخلي.",
      "loginWaBtn": "تسجيل الدخول برقم واتساب (WaForge) أو Google",
      "loginWaHint": "يصلك رمز التحقق الفوري OTP مباشرة عبر واتساب",
      "corpBadge": "تعاقدات الشركات والمؤسسات",
      "corpPrompt": "هل تمثل شركة أو منظمة وترغب في تدريب كوادركم؟",
      "corpOpenForm": "فتح Google Form المباشر ↗",
      "corpFormDesc": "يمكن للمؤسسات والمنظمات التقدم بطلب تدريب جماعي مخصص دون الحاجة لتسجيل دخول مسبق:",
      "corpOrgLabel": "اسم الشركة أو المنظمة *",
      "corpCountLabel": "عدد المتدربين *",
      "corpCountPlaceholder": "مثال: 15",
      "corpPhoneLabel": "رقم هاتف / واتساب المنسق *",
      "corpEmailLabel": "البريد الإلكتروني المؤسسي *",
      "corpTrackLabel": "المسار التدريبي المطلوب",
      "corpSubmitBtn": "إرسال طلب تدريب المؤسسة وتأكيد الحجز",
      "corpSuccess": "تم استلام طلب تدريب المؤسسة بنجاح! سيتواصل فريق التدريب معكم لتنسيق المواعيد والحقائب التدريبية.",
      "welcomeUser": "مرحباً بك،",
      "activeRole": "صلاحية الحساب النشط:",
      "workSpace": "مساحة العمل المؤسسية",
      "logoutBtn": "تسجيل الخروج",
      "studentSpaceTitle": "مساحتي التعليمية والتدريبية",
      "studentSpaceDesc": "تحميل ملفات التدريب مباشرة من Google Drive ومتابعة الخطة الدراسية مع المدرب",
      "studentSessionActive": "جلسة طالب نشطة",
      "enrolledCourseActive": "مسجل • دورة جارية",
      "courseInstructorLabel": "المدرب:",
      "instructorOnline": "متصل الآن",
      "progressTitle": "نسبة الإنجاز",
      "progressSubtitle": "إكمال 4 من 6 وحدات تدريبية",
      "progressPercent": "75% مكتمل",
      "driveFilesTitle": "ملفات وحقائب التدريب (تحميل مباشر من Google Drive)",
      "driveFilesSecured": "سحابة Google Drive مؤمنة",
      "directDownloadBtn": "تحميل مباشر",
      "directDownloadToast": "جاري التحميل المباشر من Google Drive لملف:",
      "chatWithInstructor": "المحادثة المباشرة مع المدرب",
      "chatInstructorTitle": "د. أسامة المنصور",
      "chatInstructorRole": "مدرب معتمد للمعيار الإنساني CHS",
      "chatLiveTag": "شات مباشر",
      "chatGreetingMsg": "أهلاً بك. يرجى مراجعة ملفات مصفوفة الامتثال xlsx المرفقة للبدء بحل التمارين التفاعلية.",
      "chatInputPlaceholder": "اكتب استفسارك للمدرب هنا...",
      "chatSendBtn": "إرسال",
      "instructorSpaceTitle": "بوابة المدرب وإدارة المحتوى الأكاديمي",
      "instructorSpaceDesc": "رفع الحقائب التدريبية ومصادر التعلم إلى Google Drive ومتابعة قائمة الطلاب وتفاعلهم",
      "instructorSessionActive": "جلسة مدرب نشطة",
      "uploadDriveTitle": "رفع وتخزين الملفات والحقائب على Google Drive",
      "uploadDriveDesc": "قم برفع ملفات PDF أو العروض التقديمية أو أوراق العمل. ستكون متاحة للتنزيل الفوري للطلاب المسجلين.",
      "dragDropTitle": "اسحب وأفلت الملفات هنا، أو انقر للاختيار من جهازك",
      "dragDropHint": "يدعم صيغ PDF, PPTX, DOCX, XLSX حتى 100 ميجابايت",
      "uploadingToDrive": "جاري الرفع السحابي إلى مجلد Google Drive المشترك...",
      "uploadSuccess": "تم رفع الملف وحفظه بنجاح في Google Drive وربطه بالدورة!",
      "enrolledStudentsTitle": "قائمة الطلاب المسجلين والتفاعل",
      "tableStudentName": "اسم الطالب",
      "tableCourse": "المقرر التدريبي",
      "tableProgress": "الإنجاز",
      "tableStatus": "الحالة",
      "tableAction": "إجراء",
      "chatStudentBtn": "مراسلة",
      "adminSpaceTitle": "لوحة التحكم المؤسسية وإدارة المقررات",
      "adminSpaceDesc": "تفعيل وإيقاف المقررات، تعيين المدربين، متابعة سجلات الحفظ العائمة، وإدارة النظام",
      "adminSessionActive": "جلسة إدارة عامة",
      "statActiveCourses": "الدورات النشطة",
      "statTotalTrainees": "إجمالي المتدربين",
      "statCompletionRate": "معدل الإنجاز العام",
      "statCertificates": "الشهادات الصادرة",
      "manageCoursesTitle": "إدارة حالة المقررات وتفعيل التسجيل",
      "savePanelNotice": "تم تعديل حالة المقررات. استخدم لوحة الحفظ بالأسفل لتثبيت التغييرات.",
      "saveChangesBtn": "حفظ التغييرات الآن",
      "discardBtn": "إلغاء التعديل",
      "savedToast": "تم حفظ واعتماد كافة التغييرات على قاعدة البيانات بنجاح!"
},
    footerData: {
      ...
      "quickSectionsTitle": "الأقسام المؤسسية",
      "standardsTitle": "المرجعيات والمعايير الدولية",
    ...
    services: {
    socialSection: {
      "badge": "Actividades y Operaciones de Campo",
      "title": "Publicaciones y Actividades Oficiales",
      "subtitle": "Siga nuestros últimos talleres, misiones de evaluación de campo y programas de desarrollo publicados en Facebook e Instagram.",
      "viewFb": "Ver en Facebook ↗",
      "viewInsta": "Ver en Instagram ↗",
      "posts": [
            {
                  "title": "Taller sobre la Norma Humanitaria Esencial (CHS) y Rendición de Cuentas",
            ...
            },
            {
                  ...
                  "platform": "Facebook",
                  "excerpt": "Despliegue de equipos evaluadores para medir relevancia, impacto, eficiencia y sostenibilidad conforme a las directrices de UNEG.",
                  "link": "https://www.facebook.com/shat.development.growth/",
    ...
    moodleLMS: {
      "gateBadge": "Acceso Restringido • Sistema Moodle Institucional",
      "gateTitle": "Plataforma Moodle de Academia y Capacitación",
      "gateDesc": "Entorno de aprendizaje profesional dedicado a estudiantes, formadores y administradores de SHAT Development & Growth.",
      "gatePrompt": "Inicie sesión para acceder a su espacio Moodle designado",
      "gateRolesIntro": "La plataforma proporciona un entorno adaptado a su perfil verificado:",
      "roleStudentTitle": "Cuenta de Estudiante / Participante",
      "roleStudentDesc": "Acceso a cursos, seguimiento de avance, descarga directa de archivos Google Drive y chat con el docente.",
      "roleInstructorTitle": "Cuenta de Formador / Docente",
      "roleInstructorDesc": "Carga de materiales a Google Drive, control de asistencia e interacción directa con los participantes.",
      "roleAdminTitle": "Cuenta de Administración y Gestión",
      "roleAdminDesc": "Activación/desactivación de cursos, panel flotante de guardado y supervisión de comunicaciones.",
      "loginWaBtn": "Iniciar sesión con WhatsApp (WaForge) o Google",
      "loginWaHint": "Código de verificación instantáneo (OTP) enviado directamente a su WhatsApp",
      "corpBadge": "Contratos Corporativos e Institucionales",
      "corpPrompt": "¿Representa a una institución u organización interesada en capacitar a su personal?",
      "corpOpenForm": "Abrir Google Form Directo ↗",
      "corpFormDesc": "Las organizaciones pueden solicitar formación grupal a medida sin requerir cuenta previa:",
      "corpOrgLabel": "Nombre de la empresa u organización *",
      "corpCountLabel": "Número de participantes *",
      "corpCountPlaceholder": "Ej.: 15",
      "corpPhoneLabel": "Teléfono / WhatsApp del coordinador *",
      "corpEmailLabel": "Correo institucional oficial *",
      "corpTrackLabel": "Área de formación solicitada",
      "corpSubmitBtn": "Enviar solicitud corporativa y confirmar",
      "corpSuccess": "¡Solicitud recibida con éxito! Nuestro equipo pedagógico se pondrá en contacto en breve.",
      "welcomeUser": "Bienvenido/a,",
      "activeRole": "Rol activo:",
      "workSpace": "Espacio Institucional",
      "logoutBtn": "Cerrar Sesión",
      "studentSpaceTitle": "Mi Espacio de Aprendizaje y Capacitación",
      "studentSpaceDesc": "Descargue materiales directamente desde Google Drive y gestione sus módulos de formación",
      "studentSessionActive": "Sesión de Estudiante Activa",
      "enrolledCourseActive": "Inscrito • En Curso",
      "courseInstructorLabel": "Docente:",
      "instructorOnline": "En Línea",
      "progressTitle": "Progreso del Curso",
      "progressSubtitle": "4 de 6 módulos completados",
      "progressPercent": "75% Completado",
      "driveFilesTitle": "Paquetes y Materiales de Formación (Descarga Directa Google Drive)",
      "driveFilesSecured": "Nube Google Drive Segura",
      "directDownloadBtn": "Descarga Directa",
      "directDownloadToast": "Descargando directamente desde Google Drive:",
      "chatWithInstructor": "Consulta Directa con el Docente",
      "chatInstructorTitle": "Dr. Osama Al-Mansoor",
      "chatInstructorRole": "Formador Principal Certificado en CHS",
      "chatLiveTag": "Chat en Vivo",
      "chatGreetingMsg": "Bienvenido/a. Revise el archivo de matriz de cumplimiento adjunto para iniciar los ejercicios.",
      "chatInputPlaceholder": "Escriba su consulta al docente aquí...",
      "chatSendBtn": "Enviar",
      "instructorSpaceTitle": "Portal Docente y Gestión Pedagógica",
      "instructorSpaceDesc": "Suba materiales a Google Drive y supervise la participación de los alumnos",
      "instructorSessionActive": "Sesión de Docente Activa",
      "uploadDriveTitle": "Subir y Almacenar Materiales en Google Drive",
      "uploadDriveDesc": "Suba archivos PDF, presentaciones o ejercicios. Estarán disponibles inmediatamente para los alumnos.",
      "dragDropTitle": "Arrastre y suelte archivos aquí, o haga clic para seleccionar",
      "dragDropHint": "Soporta formatos PDF, PPTX, DOCX, XLSX hasta 100 MB",
      "uploadingToDrive": "Subiendo al repositorio en la nube de Google Drive...",
      "uploadSuccess": "¡Archivo subido y vinculado con éxito en Google Drive!",
      "enrolledStudentsTitle": "Lista de Estudiantes Inscritos y Avance",
      "tableStudentName": "Nombre del Estudiante",
      "tableCourse": "Curso",
      "tableProgress": "Avance",
      "tableStatus": "Estado",
      "tableAction": "Acción",
      "chatStudentBtn": "Mensaje",
      "adminSpaceTitle": "Control Institucional y Gestión de Cursos",
      "adminSpaceDesc": "Active o desactive cursos, asigne formadores y gestione los ajustes del LMS",
      "adminSessionActive": "Sesión de Administración General",
      "statActiveCourses": "Cursos Activos",
      "statTotalTrainees": "Total Inscritos",
      "statCompletionRate": "Tasa de Finalización",
      "statCertificates": "Certificados Emitidos",
      "manageCoursesTitle": "Gestión del Estado de Cursos e Inscripciones",
      "savePanelNotice": "Estado de cursos modificado. Utilice el panel flotante inferior para confirmar.",
      "saveChangesBtn": "Guardar Cambios Ahora",
      "discardBtn": "Cancelar",
      "savedToast": "¡Todos los cambios se han guardado exitosamente en la base de datos!"
},
    footerData: {
      "aboutText": "SHAT Development & Growth es una firma líder especializada en capacitación, desarrollo institucional y consultoría conforme a estándares internacionales.",
      "quickSectionsTitle": "Secciones Institucionales",
      "standardsTitle": "Referencias y Normas Internacionales",
    ...
    contact: {
      ...
      emailValue: "shat.company26@gmail.com",
      phoneLabel: "الهاتف والتواصل المباشر",
      phoneValue: "+972 59 287 9621",
      websiteLabel: "الموقع الإلكتروني",
      websiteValue: "https://shat-company-platform.vercel.app",
      addressLabel: "المقر الرئيسي",
      addressValue: "فلسطين • نطاق العمل: دولي وإقليمي",
...
footer: {
  ...
  en: {
    socialSection: {
      "badge": "Field Operations & Events",
      "title": "Official Social Media & Field Highlights",
      "subtitle": "Explore our latest training workshops, field evaluation missions, and institutional capacity bootcamps published across Facebook & Instagram.",
      "viewFb": "View on Facebook ↗",
      "viewInsta": "View on Instagram ↗",
      "filterAll": "All",
      "filterTraining": "Training & Standards",
      "filterProtection": "Protection & Safeguarding",
      ...
      "posts": [
        {
          "id": "post-chs",
          "category": "training",
          "title": "Core Humanitarian Standard (CHS) & Accountability Masterclass",
          "date": "September 2026",
          "readTime": "3 min read",
        ...
        },
        {
          "id": "post-psea",
          "category": "protection",
          "title": "Institutional Protection & Safeguarding Frameworks (PSEA)",
          "date": "September 2026",
          "readTime": "4 min read",
          "tag": "Protection Advisory",
          "platform": "Instagram",
        ...
        },
        {
          "id": "post-oecd",
          "category": "evaluation",
          "title": "Independent Field Evaluation Missions (OECD DAC & UNEG Criteria)",
          "date": "August 2026",
          "readTime": "5 min read",
        ...
        },
        {
          "id": "post-gov",
          "category": "governance",
          "title": "Standard Operating Procedures (SOPs) & Institutional Systems",
          "date": "August 2026",
          "readTime": "3 min read",
        ...
        },
        {
          "id": "post-moodle",
          "category": "academy",
          "title": "Executive Moodle LMS & Google Drive Cloud Portal Launch",
          "date": "September 2026",
          "readTime": "3 min read",
          "tag": "Digital Academy",
          "platform": "Facebook",
        ...
        },
        {
          "id": "post-partnerships",
          "category": "partnerships",
          "title": "Regional Strategic Alliances & Institutional Partnerships 2026",
          "date": "August 2026",
          "readTime": "4 min read",
    ...
    moodleLMS: {
      "gateBadge": "Restricted Access • Institutional Moodle LMS",
      "gateTitle": "Moodle Platform for Academy & Training",
      "gateDesc": "Advanced enterprise learning environment dedicated to students, trainers, and administrators at SHAT Development & Growth.",
      "gatePrompt": "Please sign in to access your designated Moodle environment",
      "gateRolesIntro": "The platform delivers tailored portals matching your verified credential:",
      "roleStudentTitle": "Student / Trainee Account",
      "roleStudentDesc": "Access enrolled courses, track completion, download Google Drive syllabi directly, and chat with instructor.",
      "roleInstructorTitle": "Instructor / Trainer Account",
      "roleInstructorDesc": "Upload course packages directly to Google Drive, monitor attendance roster, and interact with trainees.",
      "roleAdminTitle": "Executive Administration Account",
      "roleAdminDesc": "Toggle course activation statuses, review floating save panel, and oversee enterprise internal messaging.",
      "loginWaBtn": "Sign In with WhatsApp (WaForge) or Google",
      "loginWaHint": "Instant one-time security code (OTP) sent directly to your WhatsApp",
      "corpBadge": "Corporate & Institutional Contracts",
      "corpPrompt": "Representing an enterprise seeking bespoke staff capacity training?",
      "corpOpenForm": "Open Direct Google Form ↗",
      "corpFormDesc": "Organizations can register customized group capacity building without prior individual credentials:",
      "corpOrgLabel": "Company or Organization Name *",
      "corpCountLabel": "Number of Trainees *",
      "corpCountPlaceholder": "e.g., 15",
      "corpPhoneLabel": "Coordinator Phone / WhatsApp *",
      "corpEmailLabel": "Corporate Official Email *",
      "corpTrackLabel": "Requested Training Vertical",
      "corpSubmitBtn": "Submit Corporate Training Request & Confirm",
      "corpSuccess": "Corporate training inquiry successfully received! Our advisory team will contact you within 24 hours.",
      "welcomeUser": "Welcome,",
      "activeRole": "Active Credential:",
      "workSpace": "Enterprise Workspace",
      "logoutBtn": "Sign Out",
      "studentSpaceTitle": "My Learning & Training Portal",
      "studentSpaceDesc": "Download course files directly from Google Drive and manage your training milestones",
      "studentSessionActive": "Active Student Session",
      "enrolledCourseActive": "Enrolled • In Progress",
      "courseInstructorLabel": "Instructor:",
      "instructorOnline": "Online Now",
      "progressTitle": "Course Progress",
      "progressSubtitle": "Completed 4 of 6 learning modules",
      "progressPercent": "75% Completed",
      "driveFilesTitle": "Course Packages & Files (Direct Google Drive Download)",
      "driveFilesSecured": "Secured Google Drive Cloud",
      "directDownloadBtn": "Direct Download",
      "directDownloadToast": "Directly downloading from Google Drive:",
      "chatWithInstructor": "Direct Instructor Consultation",
      "chatInstructorTitle": "Dr. Osama Al-Mansoor",
      "chatInstructorRole": "Certified CHS Senior Master Trainer",
      "chatLiveTag": "Live Chat",
      "chatGreetingMsg": "Welcome. Please review the attached compliance matrix xlsx file to begin the interactive exercises.",
      "chatInputPlaceholder": "Type your message or inquiry here...",
      "chatSendBtn": "Send",
      "instructorSpaceTitle": "Instructor Portal & Course Administration",
      "instructorSpaceDesc": "Upload course syllabi to Google Drive, review trainee engagement, and manage coursework",
      "instructorSessionActive": "Active Instructor Session",
      "uploadDriveTitle": "Upload & Store Course Packages on Google Drive",
      "uploadDriveDesc": "Upload PDF syllabi, presentation decks, or worksheets. They will be immediately accessible to enrolled students.",
      "dragDropTitle": "Drag & drop files here, or click to browse device",
      "dragDropHint": "Supports PDF, PPTX, DOCX, XLSX up to 100 MB",
      "uploadingToDrive": "Uploading to corporate Google Drive cloud repository...",
      "uploadSuccess": "File uploaded and linked successfully in Google Drive!",
      "enrolledStudentsTitle": "Enrolled Students Roster & Progress",
      "tableStudentName": "Student Name",
      "tableCourse": "Course Track",
      "tableProgress": "Progress",
      "tableStatus": "Status",
      "tableAction": "Action",
      "chatStudentBtn": "Message",
      "adminSpaceTitle": "Executive LMS Governance & Course Control",
      "adminSpaceDesc": "Toggle course activation statuses, assign trainers, inspect change log, and govern platform settings",
      "adminSessionActive": "General Management Session",
      "statActiveCourses": "Active Courses",
      "statTotalTrainees": "Total Enrolled",
      "statCompletionRate": "Overall Completion",
      "statCertificates": "Certificates Issued",
      "manageCoursesTitle": "Course Activation & Enrollment Management",
      "savePanelNotice": "Course status modified. Use the floating action panel below to commit changes.",
      "saveChangesBtn": "Commit & Save Changes Now",
      "discardBtn": "Cancel Edit",
      "savedToast": "All platform modifications successfully committed to production database!"
},
    footerData: {
      ...
      "quickSectionsTitle": "Institutional Sections",
      "standardsTitle": "International References & Norms",
    ...
    contact: {
      ...
      addressValue: "Palestine • Operational Scope: Regional & International",
...
footer: {
  ...
  fr: {
    ...
    moodleLMS: {
      ...
      "gateDesc": "Espace d'apprentissage professionnel dédié aux étudiants, formateurs et administrateurs de SHAT Développement & Croissance.",
      "gatePrompt": "Veuillez vous connecter pour accéder à votre espace Moodle",
      "gateRolesIntro": "La plateforme propose un environnement adapté à votre profil vérifié :",
      "roleStudentTitle": "Compte Étudiant / Stagiaire",
      "roleStudentDesc": "Accès aux cours, suivi de progression, téléchargement direct des fichiers Google Drive et messagerie formateur.",
      "roleInstructorTitle": "Compte Formateur / Enseignant",
      "roleInstructorDesc": "Dépôt des supports sur Google Drive, suivi des présences et interactions directes avec les apprenants.",
      "roleAdminTitle": "Compte Direction & Administration",
      "roleAdminDesc": "Activation/désactivation des cours, barre d'actions flottante et supervision des communications internes.",
      "loginWaBtn": "Connexion via WhatsApp (WaForge) ou Google",
      "loginWaHint": "Code de vérification instantané (OTP) envoyé directement sur WhatsApp",
      "corpBadge": "Contrats Entreprises & Organisations",
      "corpPrompt": "Vous représentez une institution souhaitant former ses équipes ?",
      "corpOpenForm": "Ouvrir le Formulaire Google Direct ↗",
      "corpFormDesc": "Les organisations peuvent demander une formation de groupe sur mesure sans compte individuel préalable :",
      "corpOrgLabel": "Nom de l'entreprise ou organisation *",
      "corpCountLabel": "Nombre de participants *",
      "corpCountPlaceholder": "Ex. : 15",
      "corpPhoneLabel": "Téléphone / WhatsApp du coordinateur *",
      "corpEmailLabel": "Email professionnel officiel *",
      "corpTrackLabel": "Domaine de formation souhaité",
      "corpSubmitBtn": "Envoyer la demande institutionnelle et réserver",
      "corpSuccess": "Demande de formation reçue avec succès ! Notre équipe pédagogique vous contactera sous 24 heures.",
      "welcomeUser": "Bienvenue,",
      "activeRole": "Rôle actif :",
      "workSpace": "Espace Institutionnel",
      "logoutBtn": "Déconnexion",
      "studentSpaceTitle": "Mon Espace d'Apprentissage & Formation",
      "studentSpaceDesc": "Téléchargez les supports directement depuis Google Drive et suivez vos modules",
      "studentSessionActive": "Session Étudiant Active",
      "enrolledCourseActive": "Inscrit • Cours en Cours",
      "courseInstructorLabel": "Formateur :",
      "instructorOnline": "En Ligne",
      "progressTitle": "Taux de Progression",
      "progressSubtitle": "4 modules sur 6 complétés",
      "progressPercent": "75% Complété",
      "driveFilesTitle": "Supports & Mallettes Pédagogiques (Téléchargement Google Drive)",
      "driveFilesSecured": "Cloud Google Drive Sécurisé",
      "directDownloadBtn": "Téléchargement Direct",
      "directDownloadToast": "Téléchargement direct depuis Google Drive :",
      "chatWithInstructor": "Échange Direct avec le Formateur",
      "chatInstructorTitle": "Dr. Osama Al-Mansoor",
      "chatInstructorRole": "Formateur Principal Certifié CHS",
      "chatLiveTag": "Chat en Direct",
      "chatGreetingMsg": "Bienvenue. Veuillez consulter la matrice de conformité xlsx pour débuter les exercices pratiques.",
      "chatInputPlaceholder": "Écrivez votre message au formateur ici...",
      "chatSendBtn": "Envoyer",
      "instructorSpaceTitle": "Portail Formateur & Gestion Pédagogique",
      "instructorSpaceDesc": "Mettez en ligne les supports sur Google Drive et suivez les participants",
      "instructorSessionActive": "Session Formateur Active",
      "uploadDriveTitle": "Mise en Ligne & Stockage sur Google Drive",
      "uploadDriveDesc": "Téléversez des PDF, présentations ou feuilles de travail. Ils seront immédiatement disponibles pour les étudiants.",
      "dragDropTitle": "Glissez-déposez vos fichiers ici, ou cliquez pour parcourir",
      "dragDropHint": "Formats acceptés : PDF, PPTX, DOCX, XLSX jusqu'à 100 Mo",
      "uploadingToDrive": "Téléversement en cours sur le dossier partagé Google Drive...",
      "uploadSuccess": "Fichier téléversé avec succès sur Google Drive !",
      "enrolledStudentsTitle": "Liste des Étudiants Inscrits & Suivi",
      "tableStudentName": "Nom de l'Étudiant",
      "tableCourse": "Module de Formation",
      "tableProgress": "Progression",
      "tableStatus": "Statut",
      "tableAction": "Action",
      "chatStudentBtn": "Message",
      "adminSpaceTitle": "Gouvernance Institutionnelle & Gestion des Cours",
      "adminSpaceDesc": "Activez/désactivez les cours, assignez les formateurs et gérez les paramètres du LMS",
      "adminSessionActive": "Session Administration Générale",
      "statActiveCourses": "Cours Actifs",
      "statTotalTrainees": "Total Inscrits",
      "statCompletionRate": "Taux de Réussite",
      "statCertificates": "Certificats Émis",
      "manageCoursesTitle": "Gestion du Statut des Cours & Inscriptions",
      "savePanelNotice": "Statut des cours modifié. Utilisez le panneau flottant ci-dessous pour valider.",
      "saveChangesBtn": "Enregistrer les modifications maintenant",
      "discardBtn": "Annuler",
      "savedToast": "Toutes les modifications ont été enregistrées avec succès dans la base de données !"
},
    footerData: {
      "aboutText": "SHAT Développement & Croissance est un cabinet de premier plan spécialisé dans la formation, le renforcement des capacités et le conseil institutionnel conforme aux standards internationaux.",
      "quickSectionsTitle": "Sections Institutionnelles",
      "standardsTitle": "Référentiels & Normes Internationales",
    ...
    contact: {
      ...
      addressValue: "Palestine • Portée opérationnelle: Régionale & Internationale",
...
footer: {
  ...
  es: {
    ...
    contact: {
      ...
      addressValue: "Palestina • Alcance operativo: Regional e Internacional",
  ...
  it: {
    socialSection: {
      "badge": "Attività e Missioni sul Campo",
      "title": "Post e Attività Ufficiali",
      "subtitle": "Segui i nostri ultimi workshop, missioni di valutazione sul campo e programmi di sviluppo pubblicati su Facebook e Instagram.",
      "viewFb": "Vedi su Facebook ↗",
      "viewInsta": "Vedi su Instagram ↗",
      "posts": [
            {
                  "title": "Workshop sulla Norma Umanitaria Fondamentale (CHS) e Trasparenza",
                  "date": "Settembre 2026",
                  "tag": "Formazione & Sviluppo",
                  "platform": "Facebook",
            ...
            },
            {
                  ...
                  "date": "Agosto 2026",
                  "tag": "Valutazione Indipendente",
                  "platform": "Facebook",
                  "excerpt": "Attività sul campo per valutare pertinenza, impatto, efficienza e sostenibilità dei progetti secondo le linee guida UNEG.",
                  "link": "https://www.facebook.com/shat.development.growth/",
                  "img": "assets/logo/logo-banner.jpg"
            }
      ]
    ...
    moodleLMS: {
      "gateBadge": "Accesso Riservato • Sistema Moodle Istituzionale",
      "gateTitle": "Piattaforma Moodle per Accademia e Formazione",
      "gateDesc": "Ambiente di apprendimento avanzato dedicato a studenti, docenti e amministratori di SHAT Development & Growth.",
      "gatePrompt": "Effettua il login per accedere al tuo spazio Moodle",
      "gateRolesIntro": "La piattaforma fornisce un'area di lavoro personalizzata in base al tuo profilo verificato:",
      "roleStudentTitle": "Profilo Studente / Partecipante",
      "roleStudentDesc": "Accesso ai corsi, monitoraggio avanzamento, download diretto dei materiali da Google Drive e chat docente.",
      "roleInstructorTitle": "Profilo Docente / Formatrice",
      "roleInstructorDesc": "Caricamento materiali su Google Drive, gestione presenze e interazione diretta con gli studenti.",
      "roleAdminTitle": "Profilo Amministrazione e Direzione",
      "roleAdminDesc": "Attivazione/disattivazione corsi, pannello di salvataggio mobile e gestione comunicazioni.",
      "loginWaBtn": "Accedi con WhatsApp (WaForge) o Google",
      "loginWaHint": "Codice di sicurezza istantaneo (OTP) inviato direttamente su WhatsApp",
      "corpBadge": "Contratti Aziende e Organizzazioni",
      "corpPrompt": "Rappresenti un'organizzazione interessata alla formazione del personale?",
      "corpOpenForm": "Apri Google Form Diretto ↗",
      "corpFormDesc": "Le organizzazioni possono richiedere corsi personalizzati senza account individuale previo:",
      "corpOrgLabel": "Nome dell'azienda o organizzazione *",
      "corpCountLabel": "Numero di partecipanti *",
      "corpCountPlaceholder": "Es.: 15",
      "corpPhoneLabel": "Telefono / WhatsApp del coordinatore *",
      "corpEmailLabel": "Email istituzionale ufficiale *",
      "corpTrackLabel": "Area tematica richiesta",
      "corpSubmitBtn": "Invia richiesta istituzionale e conferma",
      "corpSuccess": "Richiesta ricevuta con successo! Il nostro team ti contatterà al più presto.",
      "welcomeUser": "Benvenuto/a,",
      "activeRole": "Ruolo attivo:",
      "workSpace": "Spazio Istituzionale",
      "logoutBtn": "Disconnetti",
      "studentSpaceTitle": "Il Mio Spazio di Apprendimento & Formazione",
      "studentSpaceDesc": "Scarica i materiali direttamente da Google Drive e gestisci i tuoi moduli di studio",
      "studentSessionActive": "Sessione Studente Attiva",
      "enrolledCourseActive": "Iscritto • Corso in Corso",
      "courseInstructorLabel": "Docente:",
      "instructorOnline": "Online",
      "progressTitle": "Avanzamento del Corso",
      "progressSubtitle": "4 di 6 moduli completati",
      "progressPercent": "75% Completato",
      "driveFilesTitle": "Pacchetti e Materiali Formativi (Download Diretto Google Drive)",
      "driveFilesSecured": "Cloud Google Drive Protetto",
      "directDownloadBtn": "Download Diretto",
      "directDownloadToast": "Download diretto da Google Drive in corso:",
      "chatWithInstructor": "Chat Diretta con il Docente",
      "chatInstructorTitle": "Dr. Osama Al-Mansoor",
      "chatInstructorRole": "Formatore Senior Certificato CHS",
      "chatLiveTag": "Chat Live",
      "chatGreetingMsg": "Benvenuto/a. Consulta la matrice di conformità xlsx allegata per iniziare le esercitazioni.",
      "chatInputPlaceholder": "Scrivi qui il tuo messaggio al docente...",
      "chatSendBtn": "Invia",
      "instructorSpaceTitle": "Portale Docenti e Gestione Corsi",
      "instructorSpaceDesc": "Carica i corsi su Google Drive e monitora l'attività degli studenti",
      "instructorSessionActive": "Sessione Docente Attiva",
      "uploadDriveTitle": "Carica e Archivia File su Google Drive",
      "uploadDriveDesc": "Carica file PDF, presentazioni o dispense. Saranno subito accessibili agli studenti iscritti.",
      "dragDropTitle": "Trascina i file qui o clicca per sfogliare il dispositivo",
      "dragDropHint": "Supporta formati PDF, PPTX, DOCX, XLSX fino a 100 MB",
      "uploadingToDrive": "Caricamento in corso nella cartella condivisa Google Drive...",
      "uploadSuccess": "File caricato e collegato con successo su Google Drive!",
      "enrolledStudentsTitle": "Elenco Studenti Iscritti e Avanzamento",
      "tableStudentName": "Nome Studente",
      "tableCourse": "Corso",
      "tableProgress": "Progresso",
      "tableStatus": "Stato",
      "tableAction": "Azione",
      "chatStudentBtn": "Messaggio",
      "adminSpaceTitle": "Governance Istituzionale & Gestione Corsi",
      "adminSpaceDesc": "Attiva o disattiva i corsi, assegna i docenti e gestisci le impostazioni della piattaforma",
      "adminSessionActive": "Sessione Amministrazione Generale",
      "statActiveCourses": "Corsi Attivi",
      "statTotalTrainees": "Totale Iscritti",
      "statCompletionRate": "Tasso di Completamento",
      "statCertificates": "Certificati Rilasciati",
      "manageCoursesTitle": "Gestione Stato Corsi & Iscrizioni",
      "savePanelNotice": "Stato corsi modificato. Utilizza il pannello inferiore per salvare le modifiche.",
      "saveChangesBtn": "Salva Modifiche Ora",
      "discardBtn": "Annulla",
      "savedToast": "Tutte le modifiche sono state salvate con successo nel database!"
},
    footerData: {
      "aboutText": "SHAT Development & Growth è una società leader nella formazione, nel rafforzamento delle capacità e nella consulenza istituzionale secondo gli standard internazionali.",
      "quickSectionsTitle": "Sezioni Istituzionali",
      "standardsTitle": "Riferimenti e Norme Internazionali",
    ...
    contact: {
      ...
      addressValue: "Palestina • Ambito operativo: Regionale e Internazionale",
