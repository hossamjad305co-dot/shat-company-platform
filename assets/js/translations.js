...
export const translations = {
  ar: {
    ...
    nav: {
      ...
      home: "الرئيسية",
      about: "نبذة عن شات",
      services: "ما الذي نقدمه",
      consulting: "التخصصات الاستشارية والتقييم",
      deliveryModel: "نموذج العمل",
      approach: "منهجيتنا المهنية",
      references: "المرجعيات والمعايير الدولية",
...
footer: {
  ...
  en: {
    ...
    nav: {
      academy: "🎓 Academia SHAT",
      academy: "🎓 SHAT Academy",
      home: "Home",
      about: "About SHAT",
      services: "What We Do",
      consulting: "Specialized Consulting & Evaluation",
      deliveryModel: "Our Delivery Model",
      approach: "Our Professional Approach",
      references: "International & Humanitarian References",
